...
3D Print the body parts from the provided STL files.

Assemble the servos and wire them according to the circuit diagram.

Upload the Code to the Arduino Nano using the Arduino IDE.

Power Up the bot with your 18650 batteries.

Watch your Spider come alive!
